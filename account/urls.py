...
urlpatterns = [
    ...
    path('password_reset/', auth_views.PasswordResetView.as_view(template_name='account/password_reset/password_reset_form.html',
                                                                 ...
                                                                 email_template_name='account/password_reset/password_reset.html',
    ...
    path('profile/delete_confirmation/', TemplateView.as_view(template_name='account/dashboard/delete_confirm.html'), name='delete_confirmation'),
    # Address
